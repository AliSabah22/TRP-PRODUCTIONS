      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="flex items-center space-x-2 mb-6">
              <span className="text-3xl font-bold text-white">TRP</span>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><span className="text-white/60 hover:text-white transition-colors">Commercials</span></li>
              <li><span className="text-white/60 hover:text-white transition-colors">Brand Films</span></li>
              <li><span className="text-white/60 hover:text-white transition-colors">Product Videos</span></li>
              <li><span className="text-white/60 hover:text-white transition-colors">Event Videos</span></li>
              <li><span className="text-white/60 hover:text-white transition-colors">Corporate Videos</span></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><span className="text-white/60 hover:text-white transition-colors">Get in Touch</span></li>
              <li><span className="text-white/60 hover:text-white transition-colors">Book a Call</span></li>
              <li><span className="text-white/60 hover:text-white transition-colors">View Our Work</span></li>
              <li><span className="text-white/60 hover:text-white transition-colors">About Us</span></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <span className="text-white/40 hover:text-white text-sm transition-colors">
              Privacy Policy
            </span>
          </div>
        </div>
