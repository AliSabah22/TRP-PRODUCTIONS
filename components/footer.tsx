      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              Simple Visions, Powerful Stories. We craft commercials and brand films that move people and drive results.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><span className="text-gray-400">Commercials</span></li>
              <li><span className="text-gray-400">Brand Films</span></li>
              <li><span className="text-gray-400">Product Videos</span></li>
              <li><span className="text-gray-400">Event Videos</span></li>
              <li><span className="text-gray-400">Corporate Videos</span></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 TRP Production. All rights reserved.
          </p>
