        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.linkedin.com/in/tyler-phillips-652109236/" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-blue transition-colors">
